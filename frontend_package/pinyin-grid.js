  ...
  async _render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <svg viewBox="0 0 ${S} ${S}" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
        <rect x="0" y="0" width="${S}" height="${S}" fill="none" stroke="${lineColor}" stroke-width="${sw}"/>
        <line x1="0" y1="${ZONE}" x2="${S}" y2="${ZONE}" stroke="${lineColor}" stroke-width="${sw}"/>
        <line x1="0" y1="${ZONE * 2}" x2="${S}" y2="${ZONE * 2}" stroke="${lineColor}" stroke-width="${sw}"/>
